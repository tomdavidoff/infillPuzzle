...
Vancouver & Transactions & B.C. Assessment & 2012-2018 for baseline price and elasticities \\
...
Figures \ref{fig:lanewayMap}, \ref{fig:duplexMap}, and \ref{fig:multiplexMap} plot the spatial distribution of three types of infill housing permits in R1-1 zones. For each figure, the sample is confined to standard-sized lots. Figure \ref{fig:lanewayMap} plots the latitude and longitude of all single family home permits that were significant addtions or alterations or new construction between 2017 and 2025. Colors of points are determined by the presence or absence of a laneway home within 20 meters of the permitted single family home (our best approximation of whether the laneway home was added to the new single family home). There is no clear visual spatial pattern in the presence of new laneway homes.\footnote{this is a change from an earlier pattern where laneway homes were more common in the East Side), per \textcite{Davidoff_etal2022}.} Figure \ref{fig:duplexMap} plots the location of duplex permits between 2019 and 2025, after the allowance of duplexes city-wide. Duplex permits are notably more common on the East Side than the West Side. 


While Vancouver has been referred to as a ``great place to have money, not to make money,'' there is a high degree of income sorting into high-priced neighbourhoods. Table \ref{tab:vancouverCorrelate} shows correlations among income, mean single detached home price (2025 dollars), the elasticity of home price per square foot with respect to square footage, the share of single family permits with laneways (2019-2025), the share of duplex permits (2019-2025), and the share of multiplex permits (2024-2025) in R1-1 zones. 

The elasticity of home price per square foot is calculated based on a
regression of log sale price per square foot divided by (main) structure square
feet for duplex and single family homes in the years 2012-2018, before new
duplexes were permitted throughout R zones (almost all R1-1 zones have a
non-trivial fraction of grandfathered or otherwise enabled duplex
sales).\footnote{For older home sales, the presence or absence of a laneway
home is not easily obtained.} That regression has the form:

\begin{equation}
	\log \frac{p_{ict}}{s_{ict}} = \sum_{c}\beta_{c}\log s_{ict}
\end{equation}


\begin{table}
\caption{\label{tab:vancouverCorrelate} Vancouver correlations: census tracts, bottom panel means at neighbourhood level}
\input{vancouverCorrelate.tex}
\end{table}
\begin{table}
...
\begin{figure}
  \caption{\label{fig:vancouverSpatial} Latitude and longitude of City of Vancouver permits issued in R1-1 zones. Bottom panel: type of permit issued since January, 2019.}
  \includegraphics[width=\textwidth]{vancouverUseSpatial.png}
\end{figure}
...
\begin{figure}
  ...
  \includegraphics[width=\textwidth]{vancouverUseShareByPPSF.png}
\end{figure}
